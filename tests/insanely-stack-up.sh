...
for i in $(seq 1 30); do
    ...
    sudo rlite-ctl ipcp-register n.1.IPCP:$i $NM1DIF
    sudo rlite-ctl ipcp-register n.2.IPCP:$i $NM1DIF
    sudo rlite-ctl ipcp-enroll n.1.IPCP:$i n.${i}.DIF $NM1DIF n.2.IPCP:$i
    NM1DIF="n.${i}.DIF"
done
