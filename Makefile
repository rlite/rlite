...
user/ipcm: user/ipcm.o user/pending_queue.o user/rina-utils.o user/rina-kernel-numtables.o user/rina-application-numtables.o user/helpers.o user/evloop.o user/application.o

user/ipcm.o:  $(HEADERS) user/pending_queue.h user/helpers.h user/evloop.h user/application.h
