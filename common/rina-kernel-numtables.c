...
struct rina_msg_layout rina_kernel_numtables[] = {
    ...
    [RINA_KERN_APPLICATION_REGISTER_RESP] = {
        .copylen = sizeof(struct rina_msg_base_resp),
        .names = 0,
    },
