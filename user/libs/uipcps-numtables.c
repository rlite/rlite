...
struct rl_msg_layout rl_uipcps_numtables[] = {
    [RLITE_U_IPCP_REGISTER] =
        {
            .copylen =
                sizeof(struct rl_cmsg_ipcp_register) - 2 * sizeof(char *),
            .strings = 2,
        },
    [RLITE_U_IPCP_ENROLL] =
        {
            .copylen = sizeof(struct rl_cmsg_ipcp_enroll) - 4 * sizeof(char *),
            .strings = 4,
        },
    [RLITE_U_BASE_RESP] =
        {
    ...
    [RLITE_U_IPCP_RIB_SHOW_REQ] =
        {
            .copylen =
                sizeof(struct rl_cmsg_ipcp_rib_show_req) - 1 * sizeof(char *),
            .strings = 1,
        },
    ...
    [RLITE_U_IPCP_POLICY_MOD] =
        {
            .copylen =
                sizeof(struct rl_cmsg_ipcp_policy_mod) - 3 * sizeof(char *),
            .strings = 3,
        },
    ...
    [RLITE_U_IPCP_CONFIG] =
        {
            .copylen = sizeof(struct rl_cmsg_ipcp_config) - 2 * sizeof(char *),
            .strings = 2,
        },
    [RLITE_U_PROBE] =
        {
    ...
    [RLITE_U_IPCP_NEIGH_DISCONNECT] =
        {
            .copylen = sizeof(struct rl_cmsg_ipcp_neigh_disconnect) -
                       2 * sizeof(char *),
            .strings = 2,
        },
    [RLITE_U_IPCP_RIB_PATHS_SHOW_REQ] =
        {
            .copylen =
                sizeof(struct rl_cmsg_ipcp_rib_show_req) - 1 * sizeof(char *),
            .strings = 1,
